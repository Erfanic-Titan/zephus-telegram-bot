...
def create_keyboard(language_code, keyboards_type):
	...
	#ai
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton(languages[language_code]['ai-new-chat'], callback_data='ai-new-chat')],
            [InlineKeyboardButton(languages[language_code]['ai-select-chat'], callback_data='ai-select-chat')],
            [InlineKeyboardButton(languages[language_code]['back'], callback_data='back-tools')]
        ])

    elif keyboards_type == 'ai-chat-management':
        keyboard = InlineKeyboardMarkup([
            [
                InlineKeyboardButton(languages[language_code]['ai-rename-chat'], callback_data='ai-rename-chat'),
                InlineKeyboardButton(languages[language_code]['ai-delete-chat'], callback_data='ai-delete-chat')
            ],
            [InlineKeyboardButton(languages[language_code]['back'], callback_data='ai-select-chat')]
        ])
        ...
        keyboard = ReplyKeyboardMarkup(
            [
                [KeyboardButton("ارسال شماره تلفن", request_contact=True)],  # دکمه درخواست شماره تلفن
            ],
            resize_keyboard=True,  # تغییر اندازه صفحه کلید
            one_time_keyboard=True,  # صفحه کلید فقط یکبار نمایش داده شود
        )
